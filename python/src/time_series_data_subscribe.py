"""
Subscribe all the streaming time series data for an entity that a user has access to.
"""
...
def data_received(message: Dict[str, Any]):
    ...
    to_print = f"Time series data for the entity '{entity_code}' was published at '{timestamp.strftime("%H:%M:%S %d-%m-%Y")}': "
    fields = body["fields"]
    first = True
...
client.subscribe(data_type="entity-time-series-data",
